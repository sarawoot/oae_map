...
function generate_xml(res) {
  ...
  if ($('#province').val() != "") {
    ...
    sld_body += '<NamedLayer><Name>oae:amphoes</Name><UserStyle><Title>Amphurs</Title><Abstract>Amphurs</Abstract><FeatureTypeStyle>';
    _
        .each(
            res.data,
            function(item) {
              sld_body += '<Rule><ogc:Filter><ogc:PropertyIsEqualTo><ogc:PropertyName>ap_idn</ogc:PropertyName><ogc:Literal>';
              sld_body += item.amphur_code
    ...
    sld_body = '<?xml version="1.0" encoding="UTF-8"?><StyledLayerDescriptor version="1.0.0" xsi:schemaLocation="http://www.opengis.net/sld StyledLayerDescriptor.xsd" xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">';
    sld_body += '<NamedLayer><Name>oae:provinces</Name><UserStyle><Title>Provinces</Title><Abstract>Provinces</Abstract><FeatureTypeStyle>';
    _
        .each(
            res.data,
            function(item) {
